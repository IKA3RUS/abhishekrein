/**
 * Forked from @react-three/drei's Cloud/Clouds components.
 *
 * random() is now scoped inside the layout effect with a local seed
 * copy, making it idempotent across SSR + hydration re-runs.
 */
...
function setUpdateRange(
  ...
  if (attr.addUpdateRange) {
    ...
    (attr as any).updateRange = { offset: start, count };
  }
}
...
const CLOUD_URL = "/images/home/cloud.png";
...
export const Cloud = /* @__PURE__ */ React.forwardRef<Group, CloudProps>(
  (props, fref) => {
    const parent = React.useContext(context);
